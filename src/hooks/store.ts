...
export const useStore = <T extends unknown>(
  ...
  query.forEach((prop) => {
    switch (prop) {
      case HOOK.RACES:
        result.races = useSelector<RootReducerType, RaceState>(
      ...
      case HOOK.RACE_SPECIFIC:
        ...
        break;
      case HOOK.SESSIONS:
        result.sessions = useSelector<RootReducerType, SessionsState>(
      ...
      case HOOK.SESSION_SPECIFIC:
        ...
        break;
      case HOOK.DRIVERS:
        result.drivers = useSelector<RootReducerType, DriversState>(
